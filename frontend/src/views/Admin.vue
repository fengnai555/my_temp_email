...
const { t, locale } = useI18n({
  messages: {
    ...
    'zh-TW': {
      ...
      ipBlacklistSettings: 'IP 黑名單',
      aiExtractSettings: 'AI 提取設定',
      appearance: '外觀',
      about: '關於',
      ok: '確定',
      mailWebhook: '郵件 Webhook',
      adminAccount: '管理員',
      loginMethod: '登入方式',
      loginViaPassword: '管理員密碼登入',
      loginViaUserAdmin: '使用者管理員權限',
      loginViaDisabledCheck: '已禁用密碼檢查',
      logout: '登出',
      logoutConfirmTitle: '確認登出',
      logoutConfirmContent: '確定要登出管理員面板嗎？',
      confirm: '確認',
      logoutSuccess: '登出成功',
    }
  }
