...
const { locale, t } = useI18n({
    messages: {
        ...
        zh: {
            ...
            getNewEmailTip2: '留空将会生成一個随机的邮箱地址。',
        ...
        'zh-TW': {
            login: '登入',
            loginAndBind: '登入並綁定',
            pleaseGetNewEmail: '請「登入」或點擊「建立新信箱」按鈕來獲取一個新的信箱地址',
            getNewEmail: '建立新信箱',
            getNewEmailTip1: '請輸入您想要使用的信箱地址，只允許：',
            getNewEmailTip2: '留空將會產生一個隨機的信箱地址。',
            getNewEmailTip3: '您可以從下拉清單中選擇一個網域。',
            credential: '信箱地址憑證',
            ok: '確定',
            generateName: '產生隨機名稱',
            help: '幫助',
            ...
            bindUserAddressError: '將信箱地址綁定到使用者時發生錯誤',
            autoGeneratedName: '自動產生名稱',
            passwordLogin: '密碼登入',
            credentialLogin: '憑證登入',
            email: '信箱',
            password: '密碼',
            emailPasswordRequired: '信箱和密碼不能為空',
        }
    }
});
